...
from components import header, profile_card, task_management, achievements, attendance, dashboard_cards
...
def trang_chu():
   ...
   # --- SIDEBAR ---
    with st.sidebar:
        ...
        modules = ["Dashboard", "Thông tin cá nhân", "Công việc", "Thành tích", "Chấm công"]  # Modules for all users
